...
describe('App.WizardStep3Controller', function () {
  ...
  describe('#removeHosts', function () {
    ...
    it('should remove hdp url prompt if no host of os_type exist', function () {
      var host1 = Em.Object.create({name: 'host1', os_type: 'os1', os_family: 'os1'});
      var host2 = Em.Object.create({name: 'host2', os_type: 'os2', os_family: 'os2'});
      var hosts = [
            host1,
            host2
          ];
    ...
    it('should not remove hdp url prompt if a host of os_type exist', function () {
      var host1 = Em.Object.create({name: 'host1', os_type: 'os1', os_family: 'os1'});
      var host2 = Em.Object.create({name: 'host2', os_type: 'os2', os_family: 'os2'});
      var host3 = Em.Object.create({name: 'host3', os_type: 'os2', os_family: 'os2'});
      var hosts = [
            host1,
            host2,
            host3
    ...
    var tests = Em.A([
      {
        ...
        data: {items: [
          {Hosts: {host_name: 'c1', os_type: 'os1'}}
        ]},
  ...
  describe('#checkRepoForNewOsType', function () {
    it('should show prompt if repos dont exist for os_type in allRepos', function () {
      var bootHosts = [
                       Em.Object.create({name: 'host1', bootStatus: 'REGISTERED', os_type: 'os1', os_family: 'os1'}),
                       Em.Object.create({name: 'host2', bootStatus: 'REGISTERED', os_type: 'os2', os_family: 'os2'})
                       ];
      var allRepos = [
                      {os_type: 'os1'}
                      ];
